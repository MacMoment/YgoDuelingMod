...
{
    private static final DeferredRegister<ZoneType> DEFERRED_REGISTER = DeferredRegister.create(ResourceLocation.fromNamespaceAndPath(YDM.MOD_ID, "zone_types"), YDM.MOD_ID);
