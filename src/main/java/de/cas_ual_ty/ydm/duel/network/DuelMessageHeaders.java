...
{
    private static final DeferredRegister<DuelMessageHeaderType> DEFERRED_REGISTER = DeferredRegister.create(Identifier.fromNamespaceAndPath(YDM.MOD_ID, "duel_message_headers"), YDM.MOD_ID);
